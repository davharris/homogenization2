...
These are already important for other reasons in basic and applied community ecology, so predictive methods from those fields [@pearse_predicting_2013; @harris_generating_2015] could help make better forecasts about homogenization than other extrapolation approaches [c.f. @rosenblad_new_2016].
