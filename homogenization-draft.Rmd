...
```{r plot_0, cache = TRUE, fig.height=3.5, fig.width=7, fig.cap = datacap}
b = blend(PLANTS[grep("LA", names(PLANTS))])
{
  ...
  abline(v = c(b$p.Star, b$p.Star/2), lty = 1:2)
  abline(h = 0)
}
```


```{r fig1, fig.cap=scoopcap, fig.height=3.5, fig.width=7, cache = TRUE}
# Figure 2 -------------------------------
